...
//        SpuInfoEntity spuInfoEntity1 = this.getOne(new QueryWrapper<SpuInfoEntity>().eq("spu_name", vo.getSpuName()));
//        // 保存spu的描述图片信息 pms_spu_info_desc
//        List<String> decript = vo.getDecript();
//        SpuInfoDescEntity spuInfoDescEntity = new SpuInfoDescEntity();
//        spuInfoDescEntity.setSpuId(spuInfoEntity1.getId());
//        spuInfoDescEntity.setDecript(String.join(",", decript));
//        spuInfoDescService.saveSpuInfoDesc(spuInfoDescEntity);
//        // 保存spu的图片集 pms_spu_images
//        List<String> images = vo.getImages();
//        imagesService.saveImages(spuInfoEntity1.getId(), images);

        // 保存spu的规格参数信息 pms_product_attr_value
        ...
        if(skus != null && skus.size() > 0){
            skus.forEach(item ->{
                ...
                skuInfoEntity.setSkuId(skuInfoEntity.getSkuId());
                ...
                // 保存sku的优惠、满减等信息 sms_sku_ladder sms_sku_full_reduction sms_member_price sms_sku_discount
